...
def build():
    ...
    story = [
        ...
        P("Explicit positive and negative feedback updates per-user embedding centroids. Pin state is derived only from that viewer's feedback events. The similarity bonus is clamped to +/-8; non-interaction is ignored; critical floors cannot be suppressed."),
        PageBreak(),
